...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ibm-cloud-sdk-core-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10068&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ibm-cloud-sdk-core-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ibm-cloud-sdk-core` can be installed with:

```
conda install ibm-cloud-sdk-core
```

It is possible to list all of the versions of `ibm-cloud-sdk-core` available on your platform with:
